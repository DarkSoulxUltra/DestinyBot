...
from DestinyBot import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from DestinyBot.modules.sql import cleaner_sql as sql
...
✮ /gignoreblue <word>*:* globally ignorea bluetext cleaning of saved word across Destiny.
