...
import DestinyBot.modules.sql.global_bans_sql as gban_sql
import DestinyBot.modules.sql.users_sql as user_sql
from DestinyBot import DEV_USERS, OWNER_ID, dispatcher
