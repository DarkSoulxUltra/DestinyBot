...
import DestinyBot.modules.sql.notes_sql as sql
from DestinyBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from DestinyBot.__main__ import DATA_IMPORT
...
# from DestinyBot.modules.rules import get_rules
import DestinyBot.modules.sql.rules_sql as rulessql

# from DestinyBot.modules.sql import warns_sql as warnssql
import DestinyBot.modules.sql.blacklist_sql as blacklistsql
from DestinyBot.modules.sql import disable_sql as disabledsql

# from DestinyBot.modules.sql import cust_filters_sql as filtersql
# import DestinyBot.modules.sql.welcome_sql as welcsql
import DestinyBot.modules.sql.locks_sql as locksql
from DestinyBot.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        ...
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `DestinyBot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("DestinyBot{}.backup".format(chat_id))  # Cleaning file
