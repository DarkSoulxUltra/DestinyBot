...
from DestinyBot import pbot as tomori
...
✮ /pokedex <pokemon name>*:* Fetches up the details about the Pokemon (if inserted correct).

Note: Ensure you spell the Pokemon name correctly, else it won't work.
"""
