...
import DestinyBot.modules.sql.connection_sql as sql
from DestinyBot import dispatcher, DRAGONS, DEV_USERS
from DestinyBot.modules.helper_funcs import chat_status
