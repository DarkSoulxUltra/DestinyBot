...
from DestinyBot import DRAGONS, dispatcher
...
from DestinyBot.modules.helper_funcs.admin_rights import (
    user_can_changeinfo,
    user_can_promote,
)
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if user_member.status in ("administrator", "creator"):
        message.reply_text(
            "Wakaranai!! How am I meant to promote someone that's already an admin?"
        )
        return
